---
title: "SummoningForm: Animated Contact Form"
sidebarTitle: "SummoningForm"
description: "SummoningForm is a three-field animated contact form with mocked submission state, a success confirmation view, and a drop-in real backend integration path."
---
...
- **Success** — The form is replaced (via AnimatePresence) by a confirmation view: a `Sigil` with id `rune-4`, size `64`, color `magenta`, the heading "Signal Transmitted", and the subtext "The message has entered the void." After 3 seconds, the form resets to idle.
