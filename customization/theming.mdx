...
Replace any value to shift the palette. Here is a **deep blue / electric teal** variant as an example:
...
Audiowide is used in a small number of decorative accent spans. If you remove it from the import, replace those instances with `font-display` to avoid a font-stack fallback.
