---
title: "Case Studies Data Schema and Ritual Report Format"
...
Each object in the exported `c` array has the following top-level fields:
    ...
    sections: [
      {
        heading: 'Problem',
        content:
          'The legacy dashboard suffered severe performance degradation when rendering more than 500 data points. The DOM was bloated, and React was struggling to reconcile the massive component tree during real-time updates.',
      },
      {
        heading: 'Result',
        content:
          'Achieved stable 60fps rendering 15,000 data points. Payload size decreased by 40%, time-to-interactive improved by 2.5 seconds.',
      },
      // ... additional sections
    ],
  },
