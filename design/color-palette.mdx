...
|---|---|---|
| `--glow-purple` | `0 0 10px rgba(176,38,255,.5)…` | `shadow-glow-purple` / `hover:shadow-glow-purple` |
| `--glow-magenta` | `0 0 10px rgba(255,0,255,.5)…` | `shadow-glow-magenta` / `hover:shadow-glow-magenta` |
| `--glow-cyan` | `0 0 10px rgba(0,243,255,.5)…` | `shadow-glow-cyan` / `hover:shadow-glow-cyan` |
| `--glow-lime` | `0 0 10px rgba(57,255,20,.5)…` | `shadow-glow-lime` / `hover:shadow-glow-lime` |

> Each `…` expands to a second stop at 20px spread and 0.3 opacity, e.g. `, 0 0 20px rgba(176,38,255,.3)`.
